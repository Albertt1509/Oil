                    ...
                    <div class="mt-5">
                        ...
                        <form>
                            <div class="grid gap-y-4">
                                <!-- Form Group -->
                                <div>
                                    <label for="password" class="block text-sm mb-2 dark:text-dark">Password</label>
                                    <div class="relative">
                                ...
                                <div>
                                    <label for="password_confirmation" class="block text-sm mb-2 dark:text-dark">Confirm
                                        Password</label>
                                    <div class="relative">
