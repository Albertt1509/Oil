    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto h-auto">
        <div class="flex h-full items-center">
            <main class="w-full max-w-md mx-auto p-6">
                <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm  dark:border-gray-700">
                    <div class="p-4 sm:p-7">
                        ...
                        <div class="mt-5">
                            ...
                            <form wire:submit.prevent='save'>
                                @if (session('success'))
                                    <div class="bg-green-500 text-sm text-center text-white rounded-lg p-4 mb-4"
                                        role="alert">
                                        {{ session('success') }}
                                    </div>
                                @endif
                                <div class="grid gap-y-4">
                                    ...
                                    <div>
                                        ...
                                        @error('error')
                                            <p class=" text-xs text-red-600 mt-2" id="email-error">Please include a
                                                valid
