<div class="bg-[#dcdcdc]">
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <section class="overflow-hidden bg-white py-11 font-poppins dark:bg-gray-200">
            <div class="max-w-6xl px-4 py-4 mx-auto lg:py-8 md:px-6">
                <div class="flex flex-wrap -mx-4">
                    <div class="w-full mb-8 md:w-1/2 md:mb-0" x-data="{ mainImage: '{{ url('storage/', $product->images[0]) }}' }">
                        <div class="sticky top-0 z-50 overflow-hidden bg-white rounded-lg">
                            <div class="relative mb-6 lg:mb-10 lg:h-2/4">
                                <img x-bind:src="mainImage" class="object-cover w-full lg:h-full">
                            </div>
                                ...
                                <div class="flex flex-wrap items-center mt-6">
                                    <span class="mr-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="w-4 h-4 text-white-700 bi bi-truck"
                                            viewBox="0 0 16 16">
                                            <path
                    ...
                    <div class="w-full px-4 md:w-1/2">
                        <div class="lg:pl-20">
                            <div class="mb-8 [$>ul]:list-disc [$>ul]:ml-4">
                                ...
                                <p class="inline-block mb-6 text-xl font-bold text-gray-700 dark:text-gray-400">
                            ...
                            <div class="flex flex-wrap items-center gap-4">
                                <button wire:click='addToCart({{ $product->id }})'
                                    ...
                                    <span wire:loading.remove wire:target='addToCart({{ $product->id }})'> Add to
                                        cart</span> <span wire:loading wire:target='addToCart({{ $product->id }})'>Add
                                        Product</span>
                                </button>
                            </div>
                        </div>
